...
/**
 * Test for transaction MJJZT00201MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MJJZT00201MXTest.xml" })
public class MJJZT00201MXTransactionTest {

	@Autowired
	private MJJZT00201MXTransaction transaction;
