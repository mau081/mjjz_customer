...
/**
 * Test for transaction MJJZT00401MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MJJZT00401MXTest.xml" })
public class MJJZT00401MXTransactionTest {

	@Autowired
	private MJJZT00401MXTransaction transaction;
