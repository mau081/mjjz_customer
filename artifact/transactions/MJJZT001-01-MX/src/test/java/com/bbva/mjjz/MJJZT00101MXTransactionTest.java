...
/**
 * Test for transaction MJJZT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MJJZT00101MXTest.xml" })
public class MJJZT00101MXTransactionTest {

	@Autowired
	private MJJZT00101MXTransaction transaction;
